...
N_m3u8DL-RE 需要安装 ffmpeg，并添加到环境变量中。

- ffmpeg下载：https://github.com/GyanD/codexffmpeg/releases/download/4.3.2-2021-02-27/ffmpeg-4.3.2-2021-02-27-full_build-shared.7z

![image-20250727013326391](images/image-20250727013326391-1753551334749.png)



再次运行。

![image-20250727013659430](images/image-20250727013659430.png)





## N_m3u8DL-RE Command Line Usage
